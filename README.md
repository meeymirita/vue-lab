...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/vue.md](https://github.com/meeymirita/lab-fixes/blob/main/vue.md) репозитория `lab-fixes`.
