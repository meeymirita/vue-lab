...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/vue.md](https://github.com/meeymirita/submodule-group-lab/blob/main/fixes/vue.md) сборного репозитория.
